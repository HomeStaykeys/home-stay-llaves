# Conectar Home Stay a Firebase (multi-dispositivo) 🔑
...
3. Ponele un nombre, por ejemplo **`home-stay-llaves`**.
...
2. Ponele un apodo, por ej. **`home-stay-web`**. **No** marques Firebase Hosting. Clic en **Registrar app**.
3. Firebase te muestra un bloque de código con un objeto **`firebaseConfig`**. Eso es lo que necesitás.
   ...
   const firebaseConfig = {
     ...
     storageBucket: "home-stay-llaves.appspot.com",
...
3. A los pocos minutos tendrás una URL pública, por ej.
   `https://tu-usuario.github.io/home-stay/Home%20Stay%20-%20Control%20de%20Llaves.html`
