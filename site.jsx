...
function Registro() {
  ...
  function descargarBackup() {
    ...
    a.href = url; a.download = `home-stay_registro-llaves_${stamp}.json`;
    ...
    <div className="site">
      ...
      <header className="site-head no-print">
        ...
        <div className="sh-right">
          ...
          <span className="sh-obra"><Icon.building style={{ width: 16, height: 16 }} /> Edificio Home Stay · Registro de llaves</span>
        </div>
      </header>
